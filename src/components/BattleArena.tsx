...
</div><div className="hidden"><input className={inputClass + ' mt-1'} type="number" min="0" value={Number(config.battleEntryFeePossibility ?? 5000)} onChange={event => setConfig(prev => ({ ...prev, battleEntryFeePossibility: Math.max(0, Number(event.target.value) || 0) }))} /></label>
