...
<label className="text-xs text-slate-400">ค่าเข้าสนามสุ่มมอน/บอส (Possibility)<input className={inputClass + ' mt-1'} type="number" min="0" value={Number(config.randomBattleEntryFeePossibility ?? 15000)} onChange={event => setConfig(prev => ({ ...prev, randomBattleEntryFeePossibility: Math.max(0, Number(event.target.value) || 0) }))} /></label>
...
<label className="text-[10px] text-slate-400 sm:col-span-1">ค่าเข้า (Possibility)<input className={inputClass + ' mt-1'} type="number" min="0" value={RANDOM_BATTLE_ENTRY_FEE} readOnly /></label>
