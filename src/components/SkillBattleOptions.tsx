          ...
          {(u.skills || []).map(s=>{
            ...
            const primaryEffectPanel = <div className="rounded-xl border-2 border-violet-400/30 bg-violet-950/20 p-3 space-y-2">
              ...
              <div className="rounded-xl border border-violet-400/20 bg-violet-950/10 p-3 space-y-2">
                <div className="flex items-center justify-between"><div><div className="text-[10px] font-black text-violet-100">🎲 โอกาสใช้สกิล</div><div className="text-[9px] text-slate-400">โอกาสที่ AI จะเลือกใช้สกิลนี้</div></div><span className="rounded-full border border-violet-300/20 bg-violet-300/10 px-2 py-0.5 text-[8px] text-violet-100">0–100%</span></div>
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="rounded-lg border border-violet-300/10 bg-violet-300/5 px-2 py-2 text-[9px] text-violet-100/80"><b>หมายเหตุ:</b> เปอร์เซ็นต์ผลของสกิลอยู่ในกล่อง “ตั้งค่าผลหลัก” ด้านบน</div>
                </div>
