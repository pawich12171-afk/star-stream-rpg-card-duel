                ...
                {newRewardType === 'skill' && (
                  <div className="space-y-2 rounded-xl border border-cyan-500/20 bg-cyan-950/20 p-3">
                    ...
                    <div className="rounded-lg border border-fuchsia-500/30 bg-fuchsia-950/20 p-3">
                      <div className="mb-2 text-[11px] font-black text-fuchsia-200">✨ Passive ติดตัวของสกิล</div>
                      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                        ...
                        <select value={newSkillPassiveKind} onChange={e => setNewSkillPassiveKind(e.target.value as ItemPassiveEffect['kind'])} className="rounded-lg border border-slate-700 bg-slate-800 px-2 py-2 text-xs text-white"><option value="stack">สะสม Stack</option><option value="true_damage_per_stack">True Damage ต่อ Stack</option><option value="damage">เพิ่มดาเมจ</option><option value="damage_percent">เพิ่มดาเมจ %</option><option value="heal">ฟื้น HP</option><option value="heal_percent">ฟื้น HP %</option><option value="buff_stat">เพิ่มสเตตัส</option><option value="shield">โล่</option><option value="reflect">สะท้อน %</option><option value="repeat_attack_chance">ตีซ้ำ %</option><option value="critical_chance">คริ %</option></select>
